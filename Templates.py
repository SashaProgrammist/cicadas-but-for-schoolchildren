...
class Template:
    ...
    #     .............................................................
    #     {"offset": (-0.5, -0.2), "size": (0.1, 0.05)},  # Rectangle n - 1
    #     {"offset": (0.0, -0.6), "size": (0.15, 0.1)},  # Rectangle n
    # ]
    def __init__(self, name: str, rectangles):
        self.name = name
        self.rectangles = rectangles

        Template.templates[self.name] = self

    def draw(self, sours: str):
        # Загрузка текстуры
        ...
        result = sours.split('.')[0] + f"_{self.name}.png"
...
if __name__ == "__main__":
    ...
    template.draw("hash/img_B1_1_0001-01.png")
